...
const FRENCH={
  ...
  "This is the starting point of your protocol. Complete each step below so CoachMax can build your plan with precision.":"Voici le point de départ de ton protocole. Complète chaque étape afin que CoachMax puisse construire ton plan avec précision.","This is the starting point of your protocol. Complete each step below so Coach Max can build your plan with precision.":"Voici le point de départ de ton protocole. Complète chaque étape afin que Coach Max puisse construire ton plan avec précision.",
  ...
  "SESSION NOTES":"NOTES DE SÉANCE","SESSION COMPLETED ✓":"SÉANCE TERMINÉE ✓","SAVED ✓ — SESSION COMPLETED":"SAUVEGARDÉ ✓ — SÉANCE TERMINÉE","Completed":"Terminée","Tap to open session":"Touche pour ouvrir la séance","EXERCISE":"EXERCICE","SETS":"SÉRIES","REP.":"RÉP.","REPS":"RÉPÉTITIONS","TARGET":"CIBLE","TARGET LOAD":"CHARGE CIBLE",
  ...
  "Bodyweight":"Poids du corps","Calibration load":"Charge de calibration","result":"résultat","Rest: {seconds} sec":"Repos : {seconds} SEC","Rest: {seconds} SEC":"Repos : {seconds} SEC","Tempo {tempo}":"Tempo {tempo}",
  ...
  "ONBOARDING NEEDED":"ONBOARDING REQUIS","OPEN WEEK 0":"OUVRIR LA SEMAINE 0","Complete onboarding":"Complète l’onboarding","Complete your onboarding first.":"Complète d’abord ton onboarding.","Complete your onboarding to begin Week 0 data acquisition.":"Complète ton onboarding pour commencer l’acquisition de données de la Semaine 0.",
  "All required Week 0 data is complete. Ready to send.":"Toutes les données requises de la Semaine 0 sont complètes. Prêt à envoyer.","Complete: {items}.":"À compléter : {items}.","Week 0 has been sent.":"La Semaine 0 a été envoyée.","SENT TO COACHMAX":"ENVOYÉ À COACHMAX","READY TO SEND":"PRÊT À ENVOYER","REVIEW":"RÉVISER","Your Week 0 data has been sent to Max.":"Tes données de Semaine 0 ont été envoyées à Max.","Your Week 0 data has been sent to Coach Max.":"Tes données de Semaine 0 ont été envoyées à Coach Max.","Your Week 0 data has been sent. Coach Max will now build your personalized protocol.":"Tes données de Semaine 0 ont été envoyées. Coach Max va maintenant construire ton protocole personnalisé.","Collect your starting data so Coach Max can build your protocol with precision.":"Recueille tes données de départ afin que Coach Max puisse construire ton protocole avec précision.","EXERCISE USED":"EXERCICE UTILISÉ","Choose one":"Choisis-en un","lbs, bodyweight, machine setting...":"lb, poids du corps, réglage de machine…","I am not sure":"Je ne suis pas certain","UNDERSTOOD":"COMPRIS","PROTOCOL BEING CREATED":"PROTOCOLE EN CRÉATION","WEEK 0 REQUIRED":"SEMAINE 0 REQUISE","GO TO W0":"ALLER À LA SEMAINE 0","LOCKED WEEK":"SEMAINE VERROUILLÉE",
  "MISSING CHECK-IN DATA":"DONNÉES DE CHECK-IN MANQUANTES","Complete these required fields before sending your weekly check-in:":"Complète ces champs requis avant d’envoyer ton check-in hebdomadaire :","Measurements remain optional.":"Les mensurations restent facultatives.","Maximum check-ins reached for this block.":"Le nombre maximal de check-ins pour ce bloc est atteint.",
  "PREVIOUS WEEK REFERENCE":"RÉFÉRENCE DE LA SEMAINE PRÉCÉDENTE","Use this snapshot to compare how this week feels before archiving.":"Utilise cet aperçu pour comparer tes sensations de cette semaine avant de l’archiver.","Last archive":"Dernière archive","Last recorded scale weight":"Dernier poids enregistré","Sleep avg":"Sommeil moyen","Average per night":"Moyenne par nuit","Higher is better":"Plus élevé est préférable","Lower is better":"Plus bas est préférable","Soreness":"Courbatures","CARDIO CONTEXT":"CONTEXTE CARDIO","COACHING NOTE":"NOTE DE COACHING","No measurements were archived last time.":"Aucune mensuration n’a été archivée la dernière fois.",
  "waist":"taille","chest":"poitrine","flex arm":"bras fléchi","thigh":"cuisse","calf":"mollet","CHANGE":"CHANGEMENT","Missing data":"Données manquantes","Stable":"Stable","Improved":"Amélioration","Regressed":"Régression","score separate":"score séparé","Shape Score rewards waist reduction and muscle measurement increases. Changes under 0.25 in are treated as stable. Bodyweight is tracked separately and does not affect the score.":"Le score physique récompense la réduction du tour de taille et l’augmentation des mensurations musculaires. Les changements inférieurs à 0,25 po sont considérés comme stables. Le poids corporel est suivi séparément et n’influence pas le score.",
  "⚖ BODYWEIGHT":"⚖ POIDS CORPOREL","☾ SLEEP":"☾ SOMMEIL","⚡ ENERGY":"⚡ ÉNERGIE","◎ STRESS":"◎ STRESS","✚ SORENESS":"✚ COURBATURES","♡ CARDIO":"♡ CARDIO","Quality":"Qualité","Monitor — note where":"À surveiller — précise l’endroit","No key lifts configured":"Aucun exercice clé configuré",
  "ACTIVE PHASE":"PHASE ACTIVE","ACTIVE":"ACTIVE","COMPLETED":"TERMINÉE","UNVERSIONED":"SANS VERSION","RESULTS":"RÉSULTATS","LOADS NOTED":"CHARGES NOTÉES","VOLUME LBS":"VOLUME LB","Before side photo":"Photo de profil avant","After side photo":"Photo de profil après","Start weight":"Poids initial","Final weight":"Poids final","Calculated result":"Résultat calculé","Poster status":"Statut de l’affiche","MISSING BEFORE PHOTO":"PHOTO AVANT MANQUANTE","MISSING START WEIGHT":"POIDS INITIAL MANQUANT","MISSING AFTER PHOTO":"PHOTO APRÈS MANQUANTE","MISSING FINAL WEIGHT":"POIDS FINAL MANQUANT","READY TO GENERATE":"PRÊT À GÉNÉRER","POSTER GENERATED":"AFFICHE GÉNÉRÉE","Ready to generate the final Father Empowering client result poster.":"Prêt à générer l’affiche finale de résultat Father Empowering.",
  "NEW WEEK 0 — FATHER EMPOWERING":"NOUVELLE SEMAINE 0 — FATHER EMPOWERING","Name":"Nom","Date":"Date","ONBOARDING":"ONBOARDING","Onboarding completed":"Onboarding complété","Front":"Face","Side":"Profil","Back":"Dos","Photo notes":"Notes sur les photos","Hips":"Hanches","Right flex arm":"Bras droit fléchi","Right thigh":"Cuisse droite","Other":"Autre","Load":"Charge","Reps":"Répétitions","reps":"répétitions","per side":" par côté","Pain / note":"Douleur / note","BASELINE CARDIO":"CARDIO DE RÉFÉRENCE","Test":"Test","Age":"Âge","Sex":"Sexe","Training level":"Niveau d’entraînement","2000 m time":"Temps au 2000 m","Average pace":"Allure moyenne","Average power":"Puissance moyenne","Estimated VO2 max":"VO2 max estimé","Fitness classification":"Classification de la condition physique","CoachMax interpretation":"Interprétation CoachMax","Comment":"Commentaire","MOBILITY / PAIN":"MOBILITÉ / DOULEUR","Pain during squat / legs":"Douleur pendant les squats / jambes","Pain during hinge":"Douleur pendant les mouvements de charnière","Pain during push":"Douleur pendant les mouvements de poussée","Pain during pull":"Douleur pendant les mouvements de tirage","Pain during cardio":"Douleur pendant le cardio","Most limited movement":"Mouvement le plus limité","Most comfortable movement":"Mouvement le plus confortable","Tight / stiff area":"Zone tendue / raide","DECISION":"DÉCISION","Ready for Coach Summary and personalized protocol creation.":"Prêt pour le résumé au coach et la création du protocole personnalisé."
};
...
function translatePattern(text,language){
  const patterns=[
    ...
    [/^Rest: (\d+) (?:sec|SEC)$/i,language==='fr'?'Repos : $1 SEC':'Rest: $1 SEC'],
    [/^Repos : (\d+) (?:s|sec|SEC)$/i,language==='fr'?'Repos : $1 SEC':'Rest: $1 SEC'],
    [/^(.*?)\b(?:Rest:|Repos :) (\d+) (?:sec|s)(.*)$/i,language==='fr'?'$1Repos : $2 SEC$3':'$1Rest: $2 SEC$3'],
    ...
    [/^RIR for (.+) set (\d+)$/,language==='fr'?'RIR pour $1, série $2':'RIR for $1 set $2'],
    ...
    ,[/^Complete: (.+)\.$/,language==='fr'?'À compléter : $1.':'Complete: $1.']
    ,[/^vs week (\d+)$/,language==='fr'?'comparativement à la semaine $1':'vs week $1']
    ,[/^W(\d+) to W(\d+)$/,language==='fr'?'S$1 à S$2':'W$1 to W$2']
    ,[/^W(\d+) to W(\d+) · score separate$/,language==='fr'?'S$1 à S$2 · score séparé':'W$1 to W$2 · score separate']
    ,[/^WEEK (\d+) CHECK-IN · (.+)$/,language==='fr'?'CHECK-IN SEMAINE $1 · $2':'WEEK $1 CHECK-IN · $2']
    ,[/^WEEK (\d+) · (.+)$/,language==='fr'?'SEMAINE $1 · $2':'WEEK $1 · $2']
    ,[/^WEEK (\d+) — (.+)$/,language==='fr'?'SEMAINE $1 — $2':'WEEK $1 — $2']
    ,[/^(.+) — COMPLETED · (.+)$/,language==='fr'?'$1 — TERMINÉE · $2':'$1 — COMPLETED · $2']
    ,[/^(.+) — ACTIVE$/,language==='fr'?'$1 — ACTIVE':'$1 — ACTIVE']
    ,[/^Quality (\d+)\/10$/,language==='fr'?'Qualité $1/10':'Quality $1/10']
    ,[/^Your final result poster will be generated after Week (\d+) using your Week 0 side photo and your final side photo\.$/,language==='fr'?'Ton affiche finale de résultat sera générée après la Semaine $1 à partir de ta photo de profil de la Semaine 0 et de ta photo finale de profil.':'Your final result poster will be generated after Week $1 using your Week 0 side photo and your final side photo.']
  ];
...
function translateTextNode(node){
  ...
  const currentCore=String(node.nodeValue||'').trim();
  const sourceCore=String(source||'').trim();
  const knownValues=[sourceCore,text(sourceCore,null,'en'),text(sourceCore,null,'fr')];
  if(currentCore&&!knownValues.includes(currentCore)){
...
function translateAttributes(node){
  ...
  names.forEach(function(name){
    ...
    const knownValues=[saved[name],text(saved[name],null,'en'),text(saved[name],null,'fr')];
    if(current&&!knownValues.includes(current))saved[name]=current;
