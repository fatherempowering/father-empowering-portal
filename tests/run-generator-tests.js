...
assert('language-engine-is-loaded-with-cache-buster', html.includes('<script src="i18n.js?v=3"></script>'));
...
assert('service-worker-keeps-versioned-language-engine', sw.includes("'./i18n.js?v=3'"));
